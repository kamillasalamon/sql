...
```js
insert into szemely (nev, szulev, foglalkozas) values ('Kis Béla', 2000, 'lakatos');
token@cqlsh:kps> insert into szemely (nev, szulev, foglalkozas) values ('Nagy Ivo', 1999, 'diak');
...
where nev='Kis Bela' and szulev=2000 and folalkozas='lakatos';
