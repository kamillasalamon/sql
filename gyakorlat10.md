...
```js
RPUSH tantargy "programozas alapjai" matematika adatbaziskezeles
RPUSH tantargy "operacios rendszerek"
```
...
```js
KEYS *a*
//alternatívája, gyorsabban fut, lehet nagyobb adatbázisra is
